...
save_crop_image = './data/uavid_crop_2/val/image'
save_crop_label = './data/uavid_crop_2/val/label'
...
save_crop_image = './data/uavid_crop/test/image'
save_crop_label = './data/uavid_crop/test/label'
