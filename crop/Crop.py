...
save_crop_image = './data/uavid_crop_25/val/image'
save_crop_label = './data/uavid_crop_25/val/label'
...
path_image = './data/uavid/test/image'
path_label = './data/uavid/test/label'

save_crop_image = './data/uavid_crop_25/test/image'
save_crop_label = './data/uavid_crop_25/test/label'
