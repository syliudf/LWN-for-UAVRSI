...
if __name__ == '__main__':
    ...
    parser.add_argument('--root', default='./datafull/', help='data directory')

    parser.add_argument('--batch_size', default=4, type=int)
    parser.add_argument('--max_epochs', type=int, default=100, help='the number of epochs: default 100 ')
    ...
    parser.add_argument('--savedir', default="./runs_deeplabv3/", help="directory to save the model snapshot")
    # parser.add_argument('--logFile', default= "log.txt", help = "storing the training and validation logs")
    parser.add_argument('--gpu', type=str, default="5", help="default GPU devices (5)")

    args = parser.parse_args()

    run_id = 'deeplabv3+_Res101_lr0.004_bs4_3'
