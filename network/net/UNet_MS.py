...
class UNet(nn.Module):
    def __init__(self, n_channels, n_classes):
        ...
        self.down1 = BasicConv2d(64, 128, kernel_size=3, stride=1, padding=1)
        self.resize1 = Resize((256, 256), 64)

        self.DownsizeLayer2 = DownsizeLayer(128, 128)
        self.down2 = BasicConv2d(128, 256, kernel_size=3, stride=1, padding=1)
        self.resize2 = Resize((128, 128), 128)

        self.DownsizeLayer3 = DownsizeLayer(256, 256)
        self.down3 = BasicConv2d(256, 512, kernel_size=3, stride=1, padding=1)
        self.resize3 = Resize((64, 64), 256)

        self.down4 = BasicConv2d(512, 512, kernel_size=1, stride=1)
