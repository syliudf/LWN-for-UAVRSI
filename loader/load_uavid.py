...
class uavidloader(Dataset):
    ...
    def __init__(self, root, split='train', crop_size=512, scale=False, rotate=True, HorizontalFlip=True, normalize=False, degree=10):
        ...
        # ├── nDSM
        # └── RGB
        # root = '../data/uavid_crop'
        # print(os.path.join(self.root, self.split, 'image'))
        ...
        print('u dataset have {} images.'.format(len(self.image_list)))
